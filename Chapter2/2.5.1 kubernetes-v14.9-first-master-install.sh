...
ssh master02 mkdir /opt/k8s/{cfg,ssl,bin} -p
ssh master03 mkdir /opt/k8s/{cfg,ssl,bin} -p
ssh node01 mkdir /opt/k8s/{cfg,ssl,bin} -p
ssh node02 mkdir /opt/k8s/{cfg,ssl,bin} -p
ssh node03 mkdir /opt/k8s/{cfg,ssl,bin} -p

scp /opt/k8s/ssl/* master02:/opt/k8s/ssl/
scp /opt/k8s/ssl/* master03:/opt/k8s/ssl/
scp /opt/k8s/ssl/* node01:/opt/k8s/ssl/
scp /opt/k8s/ssl/* node02:/opt/k8s/ssl/
scp /opt/k8s/ssl/* node03:/opt/k8s/ssl/
